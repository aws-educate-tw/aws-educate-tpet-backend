...
def upgrade() -> None:
    ...
    op.add_column('runs', sa.Column('event_time', sa.TIMESTAMP(timezone=True), nullable=True))
    op.add_column('runs', sa.Column('registration_deadline', sa.TIMESTAMP(timezone=True), nullable=True))
    op.add_column('runs', sa.Column('participation_num', sa.Integer(), nullable=False, server_default='0'))
