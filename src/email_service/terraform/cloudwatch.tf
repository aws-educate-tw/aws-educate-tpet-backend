...
#########################################################
#########################################################
# Auto-resumer DLQ Message Count >= 1 ###################
#########################################################
#########################################################
#########################################################
resource "aws_cloudwatch_metric_alarm" "email_service_dlq_message_count_gte_1" {
  # Title: [Severity][Service] - {condition}
  alarm_name          = "[P2][Email-Service] - DLQ Message Count >= 1"
