...
class RunRepository:
    ...
    def increment_success_email_count(self, run_id: str) -> None:
        """
        Increment the success_email_count for a run in the DynamoDB table.
        ...
        try:
            self.table.update_item(
                Key={"run_id": run_id},
                UpdateExpression="ADD success_email_count :increment_value",
                ExpressionAttributeValues={":increment_value": 1},
