...
# Template variables that are generated by the system (not required to exist
# in the spreadsheet columns / DIRECT recipient's template_variables).
RSVP_SYSTEM_GENERATED_TEMPLATE_VARIABLES = {"jwt_token", "participant_id", "email_id"}
...
def validate_template_variables(
    ...
    system_generated_variables: set[str] | None = None,
) -> None:
            ...
            if recipient_source == RecipientSource.SPREADSHEET.value:
                ...
                if template_content:
                    validate_template_variables(
                        ...
                        error_collector,
                        rows=rows,
                        system_generated_variables=(
                            RSVP_SYSTEM_GENERATED_TEMPLATE_VARIABLES
                            if run_type == RunType.RSVP.value
                            else None
                        ),
                    )
