...
locals {
  ...
  function_name = "onboarding-vincent"
  ecr_repo_name = "onboarding-vincent"
  path_include  = ["**"]
...
module "onboarding_lambda" {
  ...
  description    = "AWS Educate TPET onboarding-vincent in ${var.environment}: GET /onboarding/vincent"
