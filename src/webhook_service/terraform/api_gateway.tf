...
module "api_gateway" {
  ...
  routes = {
    ...
    "GET /webhooks/{webhook_id}" = {
      ...
      integration = {
        uri                    = module.get_webhook_lambda.lambda_function_arn # Remember to change
        type                   = "AWS_PROXY"
        payload_format_version = "1.0"
        timeout_milliseconds   = 29000
      }
    ...
    "PUT /webhook/{webhook_id}" = {
      ...
      integration = {
        uri                    = module.update_webhook_lambda.lambda_function_arn # Remember to change
        type                   = "AWS_PROXY"
        payload_format_version = "1.0"
        timeout_milliseconds   = 29000
      }
    ...
    "POST /webhook" = {
      ...
      integration = {
        uri                    = module.save_webhook_lambda.lambda_function_arn # Remember to change
        type                   = "AWS_PROXY"
        payload_format_version = "1.0"
        timeout_milliseconds   = 29000
      }
    ...
    "POST /trigger-webhook/{webhook_id}" = {
      ...
      integration = {
        uri                    = module.trigger_webhook_lambda.lambda_function_arn # Remember to change
        type                   = "AWS_PROXY"
        payload_format_version = "1.0"
        timeout_milliseconds   = 29000
      }
